...
class Konsumen extends SB_Controller 
{

	protected $layout 	= "layouts/main";
	public $module 		= 'konsumen';
	public $per_page	= '10';
	...
	function index() 
	{
		...
		$this->data['content'] = $this->load->view('konsumen/index',$this->data, true );
	...
	function show( $id = null) 
	{
		...
		$this->data['id'] = $id;
		$this->data['content'] =  $this->load->view('konsumen/view', $this->data ,true);	  
		$this->load->view('layouts/main',$this->data);
	}
	...
	function add( $id = null ) 
	{
		...
		$this->data['id'] = $id;
		$this->data['content'] = $this->load->view('konsumen/form',$this->data, true );		
	  	$this->load->view('layouts/main', $this->data );
	...
	function save() {
		...
		if( !empty($rules) && $this->form_validation->run()){
			...
			{
				redirect( 'konsumen/add/'.$ID,301);
			} else {
				redirect( 'konsumen',301);
			}				
	}
