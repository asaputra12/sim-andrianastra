...
class Retur extends SB_Controller 
{
	...
	function index() 
	{
		...
		$this->data['content'] = $this->load->view('retur/index',$this->data, true );
	...
	function show( $id = null) 
	{
		...
		if($row)
		{
			...
			$this->data['row'] = $this->model->getColumnTable('tb_retur'); 
		}
		
		$this->data['id'] = $id;
		$this->data['content'] =  $this->load->view('retur/view', $this->data ,true);	  
		$this->load->view('layouts/main',$this->data);
	}
	...
	function add( $id = null ) 
	{
		...
		$this->data['id'] = $id;
		$this->data['content'] = $this->load->view('retur/form',$this->data, true );		
	  	$this->load->view('layouts/main', $this->data );
