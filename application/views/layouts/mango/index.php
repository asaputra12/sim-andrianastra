	...
	<div class="container">
		<div class="navbar navbar-default ">			
				<div class="navbar-header">
					...
					<img src="<?php echo base_url().'sximo/themes/mango/img/logo4.png'?>" class="img-responsive" width="70" height="70" />
...
<div id="footer">
	<div class=" container">
		<div class="col-md-7"> Copyright 2017 <?php echo CNF_APPNAME ?> . ALL Rights Reserved. <a href="#">Privacy Policy</a> | <a href="#">Terms of Service</a></div>
